import { Coffee, Fan, Lightbulb, Tv, Users } from "lucide-react";
			...
			<div className="flex items-center justify-between mb-6 z-10 relative">
				...
				<div className="flex gap-4 text-xs font-bold text-[var(--sea-ink-soft)] uppercase tracking-wider">
					<span className="flex items-center gap-1.5">
						<Lightbulb size={14} className="text-amber-400" /> Lights
					</span>
					<span className="flex items-center gap-1.5">
						<Fan size={14} className="text-teal-400" /> Fans
					</span>
				</div>
			</div>
			...
			<div className="relative w-full aspect-[16/9] max-w-5xl mx-auto bg-neutral-900/5 dark:bg-black/40 rounded-2xl border-2 border-neutral-200/50 dark:border-neutral-800/50 p-4">
				...
				<div className="w-full h-full grid grid-cols-5 grid-rows-2 gap-4 relative">
					...
					<div className="absolute bottom-[-15px] left-10 flex flex-col items-center animate-bounce z-30">
						<div className="text-[10px] font-black tracking-widest text-teal-500 mb-1">
							ENTRY
						</div>
					...
					<div className="col-span-2 row-span-2 bg-gradient-to-br from-white to-neutral-100 dark:from-neutral-900 dark:to-black rounded-xl border border-[var(--line)] relative overflow-hidden shadow-inner flex flex-col">
						...
						<div className="absolute top-16 right-8 w-8 h-20 bg-neutral-200 dark:bg-neutral-800 rounded opacity-70 flex items-center justify-center">
							<Tv size={14} className="text-neutral-400" />
						</div>

						{/* Devices (2 Fans, 3 Lights) */}
						<div className="absolute top-1/4 left-1/3">
							<DeviceIcon device={getDevice("drawing_room", "light", 1)} />
						</div>
						<div className="absolute top-1/4 right-1/4">
							<DeviceIcon device={getDevice("drawing_room", "light", 2)} />
						</div>
						<div className="absolute bottom-1/3 left-1/2">
							<DeviceIcon device={getDevice("drawing_room", "light", 3)} />
						</div>

						<div className="absolute top-1/2 left-1/3">
							<DeviceIcon device={getDevice("drawing_room", "fan", 1)} />
						</div>
						<div className="absolute top-1/2 right-1/3">
							<DeviceIcon device={getDevice("drawing_room", "fan", 2)} />
						</div>
					</div>
					...
					<div className="col-span-3 row-span-1 bg-gradient-to-br from-white to-neutral-100 dark:from-neutral-900 dark:to-black rounded-xl border border-[var(--line)] relative overflow-hidden shadow-inner">
						...
						<div className="absolute top-1/3 left-1/4">
							<DeviceIcon device={getDevice("work_room_1", "light", 1)} />
						</div>
						<div className="absolute top-1/3 left-1/2">
							<DeviceIcon device={getDevice("work_room_1", "light", 2)} />
						</div>
						<div className="absolute top-1/3 right-1/4">
							<DeviceIcon device={getDevice("work_room_1", "light", 3)} />
						</div>

						<div className="absolute bottom-1/3 left-1/3">
							<DeviceIcon device={getDevice("work_room_1", "fan", 1)} />
						</div>
						<div className="absolute bottom-1/3 right-1/3">
							<DeviceIcon device={getDevice("work_room_1", "fan", 2)} />
						</div>
					</div>
					...
					<div className="col-span-3 row-span-1 bg-gradient-to-br from-white to-neutral-100 dark:from-neutral-900 dark:to-black rounded-xl border border-[var(--line)] relative overflow-hidden shadow-inner">
						...
						{/* Devices (2 Fans, 3 Lights) */}
						<div className="absolute top-1/3 left-1/4">
							<DeviceIcon device={getDevice("work_room_2", "light", 1)} />
						</div>
						<div className="absolute bottom-1/3 left-1/2">
							<DeviceIcon device={getDevice("work_room_2", "light", 2)} />
						</div>
						<div className="absolute top-1/3 right-1/4">
							<DeviceIcon device={getDevice("work_room_2", "light", 3)} />
						</div>

						<div className="absolute top-1/2 left-1/3">
							<DeviceIcon device={getDevice("work_room_2", "fan", 1)} />
						</div>
						<div className="absolute top-1/2 right-1/3">
							<DeviceIcon device={getDevice("work_room_2", "fan", 2)} />
						</div>
					</div>
