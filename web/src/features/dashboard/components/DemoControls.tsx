...
export function DemoControls({ onUpdate }: { onUpdate: () => void }) {
	...
	return (
		<div className="fixed bottom-4 left-4 z-50 bg-black/80 backdrop-blur-md border border-white/20 p-4 rounded-2xl shadow-2xl text-white text-xs max-w-[200px]">
